...
experimental:
  plugins:
    jwt:
      moduleName: github.com/RickyCook/jwt-middleware
      version: v1.1.6
```
...
command:
  ...
  - "--experimental.plugins.jwt.modulename=github.com/RickyCook/jwt-middleware"
  - "--experimental.plugins.jwt.version=v1.1.6"
```
